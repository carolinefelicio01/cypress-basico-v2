...
describe('Central de Atendimento ao Cliente TAT', function() {
    ...
    it('exibe mensagem de erro ao submeter o formulário com um email com formatação inválida', function(){
        ...
        cy.get('#lastName').type('Felicio')
        cy.get('#email').type('caroline.felicio@gmail,com')
        cy.get('#open-text-area').type('Teste com classe de error')
        cy.contains('button', 'Enviar').click()
    ...
    it('exibe mensagem de erro quando o telefone se torna obrigatório mas não é preenchido antes do envio do formulário', function(){
        ...
        cy.get('#open-text-area').type('Teste número de telefone obrigatório')
        cy.contains('button', 'Enviar').click()
    ...
    it('preenche e limpa os campos nome, sobrenome, email e telefone', function(){
        cy.get('#firstName')
          ...
          cy.get('#lastName')
          .type('Felicio')
          .should('have.value', 'Felicio')
          .clear()
          .should('have.value', '')

          cy.get('#email')
          .type('caroline.felicio@gmail.com')
          .should('have.value', 'caroline.felicio@gmail.com')
          .clear()
          .should('have.value', '')
